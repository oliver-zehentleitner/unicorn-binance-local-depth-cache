...
- `unicorn-binance-websocket-api>=2.10.2` — WebSocket stream management (UBWA)
- `unicorn-binance-rest-api>=2.8.1` — REST snapshot fetching (UBRA)
...
- `unit-tests.yml` — Python 3.8–3.13, Codecov upload
...
3. Once synced, updates applied continuously from WebSocket diff stream
